...
if __name__ == '__main__':
    ...
    #%% Initialize dataset
    filepath = 'Richard3.txt'
    dataset = Richard3Dataset(filepath, crop_len=2)
    ...
    dataset = Richard3Dataset(filepath, crop_len, transform=trans)
