...
from earnest_dataset import encode_text, create_one_hot_matrix
...
parser.add_argument('--chapter_seed', type=str, default='almost time for a tea ', help='Initial text of the chapter')
parser.add_argument('--model_dir',   type=str, default='Final results - epochs #10257', help='Network model directory')
parser.add_argument('--length', type=int, default=600, help='Length')
