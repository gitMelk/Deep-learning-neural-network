...
parser.add_argument('--chapter_seed', type=str, default='virgilio a me disse', help='Initial text of the chapter')
parser.add_argument('--model_dir',   type=str, default='Final results - epochs #10204', help='Network model directory')
