...
# Dataset
parser.add_argument('--datasetpath',    type=str,   default='baruffe.txt',    help='Path of the train txt file')
parser.add_argument('--crop_len',       type=int,   default=40,    help='Number of input letters')
parser.add_argument('--alphabet_len',   type=int,   default=33,    help='Number of letters in the alphabet')
...
# Save
parser.add_argument('--out_dir',     type=str,   default='baruffe',    help='Where to save models and params')
