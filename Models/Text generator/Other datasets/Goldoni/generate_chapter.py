...
from dante_dataset import encode_text, create_one_hot_matrix
...
parser.add_argument('--chapter_seed', type=str, default='la mia locanda non ha mai camere in ozio', help='Initial text of the chapter')
parser.add_argument('--model_dir',   type=str, default='Final results - epochs #10224', help='Network model directory')
parser.add_argument('--length', type=int, default=1000, help='Length')

##############################
##############################
##############################
def sample(input_to_soft, temperature):
...
if __name__ == '__main__':
 #%%   
    ...
    with torch.no_grad():
        ...
        next_char_encoded = sample(net_out[:, -1, :],temp_value)
